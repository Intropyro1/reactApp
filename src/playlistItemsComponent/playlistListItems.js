...
var PlaylistListItems = function (_a) {
    ...
    var keyGen = function () {
        increment++;
        var newKey = randomkey + increment;
        return newKey;
    };
    useEffect(function () {
        var fetchPlaylists = function () { return __awaiter(void 0, void 0, void 0, function () {
            var playlists;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Spotify.getUserPlaylists()];
                    case 1:
                        playlists = _a.sent();
